...
var routes = [{
        path: 'positions',
        component: positionDashboard_component_1.PositionDashboardComponent,
    }, {
        path: 'positions/:id',
        component: position_profile_component_1.PositionProfileComponent,
    }];
var PositionRoutingModule = (function () {
